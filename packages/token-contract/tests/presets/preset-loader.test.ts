...
import {
  ...
  getAvailablePresets,
  validatePreset,
} from '../../src/presets/preset-loader.js';
...
describe('Preset Loader', () => {
  ...
  describe('loadPreset', () => {
    ...
    it('should throw error for invalid preset name', () => {
      expect(() => loadPreset('invalid-preset' as any)).toThrow();
    });
  });
