...
describe('Heading', () => {
  ...
  describe('Levels', () => {
    it('renders h1 when level=1', () => {
      render(<Heading level={1} data-testid="heading">H1</Heading>);
  ...
  describe('Accessibility', () => {
    ...
    it('maintains proper heading hierarchy', () => {
      render(
        <div>
          <Heading level={1} data-testid="h1">Title</Heading>
          <Heading level={2} data-testid="h2">Subtitle</Heading>
          <Heading level={3} data-testid="h3">Section</Heading>
        </div>
      );
