/**
 * [TAG-002] NavigationMenu Component - Horizontal navigation with dropdowns
 ...
 *
 * @tekton/ui - NavigationMenu Component
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-[var(--tekton-border-default)] shadow-md" />
  </NavigationMenuPrimitive.Indicator>
));
