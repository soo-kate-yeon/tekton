...
describe('RadioGroup', () => {
    ...
    describe('Selection Behavior', () => {
        ...
        it('supports defaultValue prop', () => {
            render(<RadioGroup defaultValue="option2">
          <RadioGroupItem value="option1" aria-label="Option 1"/>
          <RadioGroupItem value="option2" aria-label="Option 2"/>
        </RadioGroup>);
        ...
        it('supports controlled value prop', () => {
            const { rerender } = render(<RadioGroup value="option1" onValueChange={vi.fn()}>
          <RadioGroupItem value="option1" aria-label="Option 1"/>
          <RadioGroupItem value="option2" aria-label="Option 2"/>
        </RadioGroup>);
            expect(screen.getByLabelText('Option 1')).toBeChecked();
            rerender(<RadioGroup value="option2" onValueChange={vi.fn()}>
          <RadioGroupItem value="option1" aria-label="Option 1"/>
          <RadioGroupItem value="option2" aria-label="Option 2"/>
        </RadioGroup>);
            expect(screen.getByLabelText('Option 2')).toBeChecked();
    ...
    describe('User Interaction', () => {
        it('triggers onValueChange callback', async () => {
            ...
            render(<RadioGroup onValueChange={handleChange}>
          <RadioGroupItem value="option1" aria-label="Option 1"/>
          <RadioGroupItem value="option2" aria-label="Option 2"/>
        </RadioGroup>);
    ...
    describe('Accessibility', () => {
        ...
        it('has correct radiogroup role', () => {
            render(<RadioGroup aria-label="Options">
          <RadioGroupItem value="option1" aria-label="Option 1"/>
        </RadioGroup>);
            expect(screen.getByRole('radiogroup')).toBeInTheDocument();
        });
        it('supports aria-label on RadioGroup', () => {
            render(<RadioGroup aria-label="Size selection">
    ...
    describe('Edge Cases', () => {
        it('handles custom className on RadioGroup', () => {
            const { container: _container } = render(<RadioGroup className="custom-group">
          <RadioGroupItem value="option1"/>
        </RadioGroup>);
            const group = _container.firstChild;
