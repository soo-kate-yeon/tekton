...
describe('Dialog', () => {
    ...
    describe('State Management', () => {
        it('supports controlled open state', async () => {
            const { rerender } = render(<Dialog open={false} onOpenChange={vi.fn()}>
          <DialogContent>
            <DialogTitle>Controlled Dialog</DialogTitle>
          </DialogContent>
        </Dialog>);
            expect(screen.queryByText('Controlled Dialog')).not.toBeInTheDocument();
            rerender(<Dialog open={true} onOpenChange={vi.fn()}>
          <DialogContent>
            <DialogTitle>Controlled Dialog</DialogTitle>
          </DialogContent>
        </Dialog>);
        ...
        it('triggers onOpenChange callback', async () => {
            ...
            render(<Dialog onOpenChange={handleOpenChange}>
          <DialogTrigger asChild>
            <Button>Open</Button>
          </DialogTrigger>
          <DialogContent>
    ...
    describe('Edge Cases', () => {
        it('handles custom className on DialogContent', async () => {
            const { container: _container } = render(<Dialog defaultOpen>
