...
describe('LoginTemplate', () => {
    ...
    describe('Component Rendering', () => {
        ...
        it('renders with custom texts', () => {
            render(<LoginTemplateComponent texts={{
                    title: 'Custom Title',
        ...
        it('shows social login when enabled', () => {
            render(<LoginTemplateComponent options={{ social_login: true }} slots={{
                    socialLogin: (<>
        ...
        it('shows remember me when enabled', () => {
            render(<LoginTemplateComponent options={{ remember_me: true }} slots={{
                    rememberMe: (<label>
