# Proposed 5-Layer Theme JSON Structure

To achieve consistent and predictable design implementation via MCP, the theme JSON must evolve from a simple configuration dictionary into a **Complete Design System Specification**.
