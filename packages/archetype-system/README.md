...
Hook-based component archetype integration system for Tekton Design System.

## Overview

The Archetype System provides a four-layer architecture for AI-driven component generation, mapping 20 headless hooks to styling rules and visual feedback patterns. This system enables single-prompt component generation by providing structured archetype definitions that AI can consume directly.
...
### Using Archetype Schemas

```typescript
import { validateHookPropRules } from '@tekton/archetype-system';
...
```typescript
import { validateStateMapping } from '@tekton/archetype-system';
...
Comprehensive archetype documentation for AI-driven component generation:

- **[AI Master Guide](../../docs/preset_archetypes.md)** - Complete archetype reference with all 20 hooks
...
The Archetype System follows a four-layer component architecture:
...
Reference: [SPEC-ARCHETYPE-001](../../.moai/specs/SPEC-ARCHETYPE-001/spec.md)

## API Reference

### Schemas

All archetype schemas are defined in `src/schemas/`:
...
TypeScript type definitions for all archetype structures:
...
The Archetype System integrates seamlessly with the Token Contract system:
...
Archetypes are built on top of the 20 headless hooks:

```typescript
// Hook returns props and state
const { buttonProps, isPressed } = useButton();

// Archetype provides styling for both
const styles = {
...
1. **User Prompt**: "Create a Professional preset button using useButton hook"
2. **AI Identifies**:
   - Hook: `useButton` from SPEC-COMPONENT-001
   - Preset: Professional from Token Contract
   - Archetype: Button rules from preset_archetypes.md
...
**SPEC**: [SPEC-ARCHETYPE-001](../../.moai/specs/SPEC-ARCHETYPE-001/spec.md)
