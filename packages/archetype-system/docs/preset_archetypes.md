# Preset Archetypes - Hook-Based Component Generation System
...
The Archetype System defines precise mappings from React hooks to complete component implementations following these principles:
...
These examples demonstrate single-prompt component generation using the archetype system.
...
All archetype styles reference Token Contract CSS variables using this pattern:
