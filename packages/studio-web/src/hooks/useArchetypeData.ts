...
import type { VariantConfigurationOption, AccessibilitySpec } from '@tekton/archetype-system';
 ...
 */
export function useArchetypeData(hookName: HookName | null): ArchetypeData {
  return useMemo(() => {
    if (!hookName) {
      return {
        hookMeta: undefined,
